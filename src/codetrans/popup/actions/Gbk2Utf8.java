...
public class Gbk2Utf8 implements IObjectActionDelegate {
		...
		if(selection instanceof IStructuredSelection){
			...
			try {
				...
				for (IPackageFragmentRoot iPackageFragmentRoot : fragmentRoots) {
					...
					FileCharsetConverter.convert(f,"GBK","UTF-8",  new FilenameFilter() {  
				        @Override  
				...
				javaProject.getProject().setDefaultCharset("UTF-8",null);
				javaProject.getProject().refreshLocal(0, null);
